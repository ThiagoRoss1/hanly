...
def _pyqt6_probe() -> dict[str, Any]:
    ...
    try:
        ...
        worker = threading.Thread(
            target=emit_from_worker, name="han2-ui-delivery-worker", daemon=False
        )
...
def main() -> int:
    print("HAN-2 desktop threading/lifecycle spike")
